...
public class MenuController {
    ...
    public ResultEntityUtil<Menu> getWholeTreeNew() {
        ...
        return ResultEntityUtil.success(root);

    }

    @ResponseBody
    @RequestMapping("/menu/remove.json")
    public ResultEntityUtil<String> removeMenu(@RequestParam("id") Integer id) {
    ...
    public ResultEntityUtil<String> updateMenu(Menu menu) {
    ...
    public ResultEntityUtil<String> saveMenu(Menu menu) {
        // Thread.sleep(2000);
