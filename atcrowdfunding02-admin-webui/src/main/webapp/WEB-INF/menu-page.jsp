...
<%@include file="/WEB-INF/include/modal/modal-menu-add.jsp" %>
<%@include file="/WEB-INF/include/modal/modal-menu-confirm.jsp" %>
<%@include file="/WEB-INF/include/modal/modal-menu-edit.jsp" %>
</body>
</html>